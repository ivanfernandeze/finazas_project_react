...
import { FormSolvencia } from "./FormSolvencia";
import { useState } from "react";
   
export function CardSolvencia({  title, definicion, formula }) {
        ...
        <CardBody>
          ...
          <div className="grid grid-cols-3 gap-5">
            ...
            <div className="">
                ...
                < FormSolvencia setInterpretacion={setInterpretacion} formula={formula} />
            </div>
            <div className="">
                <Typography variant="h6" color="blue-gray" className="mb-4 text-center border-b">
                    Interpretación
